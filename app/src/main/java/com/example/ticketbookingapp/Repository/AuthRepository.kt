...
//        Log.d(TAG, "Starting login query for identifier: $identifier")
//
//        // Đầu tiên, xác thực với Firebase Authentication
//        auth.signInWithEmailAndPassword(identifier, password)
//            .addOnSuccessListener { authResult ->
//                // Tìm user trong Realtime Database
...
//                                    Log.d(TAG, "User found and password updated: ${user.username}")
//                                    result.value = AuthResult.Success(user)
//                                } else {
//                                    Log.e(TAG, "Failed to parse user data for email: $identifier")
//                                    result.value = AuthResult.Failure("Invalid user data")
//                                }
//                            } else {
//                                Log.d(TAG, "No user found with email: $identifier")
//                                result.value = AuthResult.Failure("User not found")
//                            }
//                        }
//
...
//            }
//            .addOnFailureListener { e ->
//                Log.d(TAG, "Firebase Authentication failed: ${e.message}")
//                result.value = AuthResult.Failure("Wrong password or user not found")
//            }
//
//        return result
//    }
...
//                        user = currentUser
//                        Log.d(TAG, "User found: ${currentUser.username}, email: $userEmail")
//                        break
//                    }
//                }
//
...
//                }
//
//                // Xác thực với Firebase Authentication bằng email
...
//                                e.message?.contains("no user record") == true -> "Email không tồn tại trong Firebase Authentication"
